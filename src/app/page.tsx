  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <a href="#applications" className="text-slate-700 hover:text-blue-600 transition">Applications</a>
      ...
      <section id="applications" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-blue-600 font-semibold text-sm uppercase tracking-wider">Applications</span>
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mt-4 mb-6">
              Écosystème Complet d'Applications
            </h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Trois applications interconnectées pour gérer efficacement les infractions routières
            </p>
          </div>

          <div className="space-y-32">
            {/* Application Agent Routier - Vidéo à gauche */}
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="rounded-xl shadow-xl overflow-hidden bg-black flex items-center justify-center">
                <video
                  className="w-full max-h-[700px] object-contain"
                  controls
                  playsInline
                >
                  <source src="/applications/agent-routière.mp4" type="video/mp4" />
                  Votre navigateur ne supporte pas la vidéo.
                </video>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-slate-900">Application Mobile Agent</h3>
                    <p className="text-sm text-blue-600 font-semibold">Pour les agents de terrain</p>
                  </div>
                </div>

                <p className="text-slate-600 leading-relaxed">
                  Outil professionnel conçu pour les agents de contrôle routier permettant un signalement
                  rapide et efficace des infractions directement sur le terrain.
                </p>
                ...
                <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
                  ...
                  <ul className="space-y-3">
                    {[
                      "Scan automatique de plaques d'immatriculation",
                      "Signalement manuel d'infractions avec géolocalisation",
                      "Capture photo/vidéo comme preuve",
                      "Accès à l'historique complet des infractions",
                      "Mode offline pour zones sans connexion",
            ...
            {/* Application Conducteur - Vidéo à droite */}
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="space-y-6 md:order-1">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-slate-900">Application Mobile Conducteur</h3>
                    <p className="text-sm text-green-600 font-semibold">Pour les conducteurs</p>
                  </div>
                </div>

                <p className="text-slate-600 leading-relaxed">
                  Application dédiée aux conducteurs pour consulter leurs infractions, recevoir des notifications
                  instantanées et effectuer des paiements en toute sécurité.
                </p>
                ...
                <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
                  ...
                  <ul className="space-y-3">
                    {[
                      "Notifications push en temps réel des infractions",
                      "Historique détaillé de toutes les infractions",
                      "Paiement en ligne sécurisé (Mobile Money, Carte)",
                      "Suivi du statut de paiement et reçus électroniques",
                      "Possibilité de contestation d'infractions",
              ...
              <div className="rounded-xl shadow-xl overflow-hidden bg-black flex items-center justify-center md:order-2">
                <video
                  className="w-full max-h-[700px] object-contain"
                  controls
                  playsInline
                >
                  <source src="/applications/driver.mp4" type="video/mp4" />
                  Votre navigateur ne supporte pas la vidéo.
                </video>
              </div>
            </div>

            {/* Application Autorités - Vidéo à gauche */}
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="rounded-xl shadow-xl overflow-hidden">
                <video
                  className="w-full max-h-[950px] object-cover"
                  controls
                  playsInline
                >
                  <source src="/applications/autorité-routière.mp4" type="video/mp4" />
                  Votre navigateur ne supporte pas la vidéo.
                </video>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-slate-900">Dashboard Autorités Routières</h3>
                    <p className="text-sm text-purple-600 font-semibold">Pour la gestion centralisée</p>
                  </div>
                </div>

                <p className="text-slate-600 leading-relaxed">
                  Plateforme desktop complète permettant aux autorités de superviser l'ensemble du système,
                  analyser les données et prendre des décisions éclairées pour améliorer la sécurité routière.
                </p>
                ...
                <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
                  ...
                  <ul className="space-y-3">
                    {[
                      ...
                      "Carte interactive des infractions géolocalisées",
                      "Filtres avancés (date, type, zone, agent)",
                      "Export de rapports (PDF, Excel, CSV)",
                      "Gestion des agents et permissions",
                      "Analyse de tendances et zones à risque"
                    ].map((feature, idx) => (
                      <li key={idx} className="flex items-start space-x-3">
          ...
          <div className="mt-12 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl p-8 border border-blue-200">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-2xl font-bold text-slate-900 mb-3">Synchronisation en Temps Réel</h3>
                <p className="text-slate-700 leading-relaxed">
                  Les trois applications sont interconnectées et synchronisées en temps réel via notre base de données centralisée.
                  Chaque infraction détectée par l'IA est instantanément visible par les autorités, notifiée au conducteur,
                  et accessible aux agents de terrain pour un contrôle efficace.
                </p>
              </div>
            </div>
          </div>
